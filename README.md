...
20+ years building digital solutions for international clients. I specialise in WordPress development, WooCommerce, performance optimisation, and UI/UX design. Studio founder with experience across the USA, Europe, Australia, and Southeast Asia.

---

### Skills

**Development** — WordPress (custom themes, plugins, CPT), WooCommerce, HTML/CSS/JS, Elementor Pro, Divi  
**Performance & QA** — Core Web Vitals, PageSpeed, security audits, cross-browser testing  
**Design** — Figma, Adobe Photoshop, responsive UI/UX  
**SEO** — On-page & technical SEO, Google Analytics  
